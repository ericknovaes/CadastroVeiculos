    ...
    <body>
        ...
        <center>
            ...
            <table class="minhaTabela">
                ...
                ?>
                <tr>
                    <td class="component1"><p><?php echo $row['placa'];?></p></td>
                    <td class="component2"><p><?php echo $row['combustivel'];?></p></td>
                    <td class="component3"><p><?php echo $row['fabricante'];?></p></td>
                    <td class="component4">
                        <a href="edit_cadastro.php?codigo=<?php echo $row['codigo']; ?>">Editar</a>
                        <a href="deletar.php?codigo=<?php echo $row['codigo'] ?>">Deletar</a>
                    </td>
                </tr>
                <?php } ?>
            </table>
